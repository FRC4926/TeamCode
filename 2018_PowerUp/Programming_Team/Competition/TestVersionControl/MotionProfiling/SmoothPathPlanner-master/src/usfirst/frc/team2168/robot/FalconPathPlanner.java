...
public static void getCSV(double[][] path, String fileName) throws Exception
	{		
		FileWriter writer = new FileWriter(new File(fileName));
		try
		{
			System.out.print("i am here");
		for(double[] outerArray : path)
		{
			for(double innerArray : outerArray)
			{
				writer.write(Double.toString(innerArray)+"," );
	...
	public static void main(String[] args)
	{
		...
		try {
			getCSV(path.smoothRightVelocity, "rightMotionProfPoints_v3");
		} catch (Exception e) {
